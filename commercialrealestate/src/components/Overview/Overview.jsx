...
function Overview() {
  return (
    <div className='w-full pt-20 pb-14 bg-gray-200'>
        ...
        <button className='flex justify-between items-center border-b border-slate-400  mb-7 text-2xl bg-indigo-800 text-white font-bold py-4 px-6 rounded-lg shadow-lg hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 transition ease-in-out duration-300 '> <GrDocumentDownload className='mr-5 text-3xl' /> Download Brochure</button>
        </div>
